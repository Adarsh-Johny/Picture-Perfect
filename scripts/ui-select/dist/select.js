    ...
    compile: function(tElement, tAttrs) {
      ...
      return function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        attrs.$observe('resetSearchInput', function() {
         ...
         if (angular.isDefined(attrs.displaykey)){
        	  $select.displayKey = attrs.displaykey;
         };
  ...
  return {
    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      scope.$on('uis:select', function (event, item) {        
        ...
        /* Logic for All condition added on 17/12/2015*/       
        if(angular.isDefined($select.displayKey)){
        	if($select.selected.length > 0){        		
	        	if(($select.selected[0][$select.displayKey] == "All") ||(item[$select.displayKey] == "All")){
	        			$select.selected = [];
	        	}   
        	}	
        }
        /* Logic for All condition ends here*/   	
